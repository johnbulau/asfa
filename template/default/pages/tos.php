...
<div class="pagetitle">
  ...
  <nav>
	<ol class="breadcrumb">
	  ...
	  <li class="breadcrumb-item active">TOS</li>
	</ol>
  </nav>
</div>
	...
	<div class="col-lg-12">
	  <div class="card">
		<div class="card-body p-2">
			<h2 class="text-dark">1) User Account</h2>
			<ol>
			...
			<hr class="global">
			<h2 class="text-dark">2) Referrals</h2>
			<ol>
			...
			<hr class="global">
			<h2 class="text-dark">5) Refund Policy</h2>
			<ol>
			...
			<hr class="global">
			<h2 class="text-dark">6) Anticheat &amp; Account Suspension</h2>
			<ol>
			...
			<hr class="global">
			<h2 class="text-dark">7) Liability</h2>
			<ol>
