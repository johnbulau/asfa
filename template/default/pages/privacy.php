	...
	<div class="col-lg-12">
	  <div class="card">
		<div class="card-body p-2">
			...
			<hr class="global">
			<h2 class="text-dark">Account Security</h2>
			<ol>
			...
			<hr class="global">
			<h2 class="text-dark">Personal Information</h2>
			<ol>
			...
			<hr class="global">
			<h2 class="text-dark">Passwords</h2>
			<ol>
			...
			<hr class="global">
			<h2 class="text-dark">Your Consent</h2>
